...
namespace LionFire.Services
{
    public static class VosInitStages
    {
        ...
        public static string RootStage(string rootName = null) => "vos:" + VosPath.GetPathForRoot(rootName);

        public static string RootMountStage(string rootName) => $"{RootStage(rootName)} Mounts";
    }
