...
{
    public class VosRetrieveInfo : RetrieveInfo // MOVE
    {
        public IReadHandle ReadHandle { get; set; }
 ...
 where ObjectType : class //,new() // TODO: Try removing new() restriction?
    {
        ...
        static VobHandle()
        {
            ...
            {
                l.Fatal("Invalid VH type: " + typeof(ObjectType).FullName + " at " + Environment.StackTrace);
        ...
        public VobHandle(params string[] subPathChunks)
        {
            ...
            //this.vob = vobHandleParent.Vob[subPathChunks];
            this.vob = Vos.Default.Root[subPathChunks];
        }
        ...
        {
            return Vos.Default[path].ToHandle<ObjectType>();
        ...
        //where T : class, new()
        {
            ...
            var vob = Vos.Default[pathElements];
        ...
        public bool AutoLoad {
            ...
            set {
                ...
                if (autoLoad)
                {
                    ...
                    {
                        if (rh.Reference.Scheme == LionFire.ObjectBus.Filesystem.FileReference.UriScheme)
                        {
