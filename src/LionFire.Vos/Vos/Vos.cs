...
namespace LionFire.ObjectBus
{
    ...
    /// </summary>
    public class Vos : OBaseBase<VosReference>, IOBase
    {
        #region (Static) Singleton

        public static Vos Default { get { return Singleton<Vos>.Instance; } }
        ...
        public override ResultType TryGet<ResultType>(VosReference reference, OptionalRef<RetrieveInfo> optionalRef = null)
        {
            var result = (ResultType)TryGet(reference, typeof(ResultType), optionalRef);
            return result;
        }
        public override object TryGet(VosReference reference, Type ResultType, OptionalRef<RetrieveInfo> optionalRef = null)
        {
            try
            {
                if (reference.Type != null)
                {
                    if (!reference.Type.IsAssignableFrom(ResultType))
                    {
                ...
                var vh = vob.ToHandle(ResultType);
