...
public interface IRootManager : IHas<IServiceProvider>
{
}
...
/// </summary>
public class RootManager : IVos, IHasMany<IParticipant>, IRootManager
{
    #region Dependencies
    ...
    public RootVob Get(string? rootName = "")
    {
        ...
        var result = roots.GetOrAdd(rootName, n =>
        {
            ...
            {
                CreateC.Add(1);
                return ActivatorUtilities.CreateInstance<RootVob>(ServiceProvider, this, n, ServiceProvider);
