...
namespace LionFire.Persistence
{
    ...
    public interface IReadWriteHandlePair<T> : IReadWriteHandlePairBase<T>
    {
        ...
        Task<(T clonedValue, bool clonedSomething)> CloneReadHandleValueToWriteHandleValue(bool allowRetrieve = true, bool propagateNoValue = false);
