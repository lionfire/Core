...
namespace LionFire.Persistence
{
    public static class IReadWriteHandlePairExtensions
    {
        ...
        /// <returns></returns>
        public static int Compare<T>(this IReadWriteHandlePairBase<T> handle, IComparer<T> comparer = null) {
        ...
        public static bool IsDeepCloneable<T>(this IReadWriteHandlePairBase<T> handle) { throw new NotImplementedException(); } // TODO
    }
}
