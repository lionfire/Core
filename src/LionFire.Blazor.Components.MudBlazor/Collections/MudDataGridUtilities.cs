...
internal class MudDataGridUtilities
{
    ...
    private static MethodInfo mi = typeof(MudDataGridUtilities).GetMethod(nameof(_BuildPropertyColumn), BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.Public);
