    ...
    where TKey : notnull
{
    ...
    // OLD
    //ITask<ILazyResolveResult<IEnumerable<TValue>>> ILazilyResolves<IEnumerable<TValue>>.TryGetValue()
    //{
    ...
    // OLD
    //ILazyResolveResult<IEnumerable<TValue>> ILazilyResolves<IEnumerable<TValue>>.QueryValue()
    //{
    ...
    #region IResolves<IEnumerable<TValue>>

    #region Resolve

    public abstract ITask<IResolveResult<IEnumerable<TValue>>> ResolveFromSource();
    ...
    public override ITask<IResolveResult<IEnumerable<TValue>>> Resolve()
    {
        lock (currentResolvingLock)
        {
            ...
            var task = Task.Run<IResolveResult<IEnumerable<TValue>>>(async () =>
            {
