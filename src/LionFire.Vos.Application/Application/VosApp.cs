...
namespace LionFire.ObjectBus
{
    ...
    public class VosApp
    {
        ...
        private void Initialize()
        {
            ...
            {
                l.Fatal("Got counter: " + vCounter.Object);
        ...
        public Vob DBs
        {
            get
            {
                if (dbs == null)
                {
                    dbs = Vos.Default[VosPaths.DBsPath];
                }
                return dbs;
            }
        }
        ...
        public Vob ActiveData
        {
            get
            {
                if (activeData == null)
                {
                    activeData = Vos.Default[VosPaths.ActiveDataPath];
                }
                return activeData;
            }
        }
        ...
        public Vob PackageStores
        {
            get
            {
                ...
                {
                    packageStores = Vos.Default[VosPaths.PackageStores];
                }
        ...
        public Vob Stores
        {
            get
            {
                if (stores == null)
                {
                    stores = Vos.Default[VosPaths.Stores];
                }
                return stores;
            }
        }
        ...
        public Vob Packages
        {
            get
            {
                if (packages == null)
                {
                    packages = Vos.Default[VosPaths.Packages];
                }
                return packages;
            }
        }
        ...
        public Vob PackageMounts
        {
            get
            {
                ...
                {
                    packageMounts = Vos.Default[VosPaths.PackageMounts];
                }
        ...
        public Vob Local
        {
            get
            {
                if (local == null)
                {
                    local = Vos.Default[VosPaths.LocalPath];
                }
                return local;
            }
        }
    ...
    public class StoreMounter
    {
        ...
        public static Mount Mount(FileReference fileReference, bool createIfMissing = true, string mountAsStoreName = null, bool? useGlobal = null)
        {
