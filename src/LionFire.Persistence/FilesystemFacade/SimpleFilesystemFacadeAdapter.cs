...
namespace LionFire.Persistence.FilesystemFacade
{
        ...
        where TPersistenceOptions : IPersistenceOptions
    {
        ...
        public Task<IGetResult<T>> TryRetrieve<T>(TReference fileReference, Lazy<PersistenceOperation> operation = null, PersistenceContext context = null) => throw new NotImplementedException();
