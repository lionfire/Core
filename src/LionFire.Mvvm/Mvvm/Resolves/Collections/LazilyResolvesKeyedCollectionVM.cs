...
public class LazilyResolvesKeyedCollectionVM<TKey, TValue, TValueVM, TCollection>
    : LazilyResolvesCollectionVM<TValue, TValueVM, TCollection>
    ...
    where TCollection : IEnumerable<TValue>
{
    ...
    public LazilyResolvesKeyedCollectionVM(IViewModelProvider viewModelProvider) : base(viewModelProvider)
    {
        this
...
// Without TCollection
public class LazilyResolvesKeyedCollectionVM<TKey, TValue, TValueVM>
    : LazilyResolvesKeyedCollectionVM<TKey, TValue, TValueVM, IEnumerable<TValue>>
    where TKey : notnull
{
    #region Lifecycle
