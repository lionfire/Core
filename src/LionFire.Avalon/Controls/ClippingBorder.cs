...
// http://stackoverflow.com/questions/120851/how-do-i-create-a-wpf-rounded-corner-container
...
namespace LionFire.Avalon
{
    ...
    public class ClippingBorder : ContentControl
    {
        ...
        #region InnerShadowThickness

        /// <summary>
        /// InnerShadowThickness Dependency Property
        /// </summary>
        public static readonly DependencyProperty InnerShadowThicknessProperty =
            DependencyProperty.Register("InnerShadowThickness", typeof(Thickness), typeof(ClippingBorder),
                new FrameworkPropertyMetadata((Thickness)default(Thickness),
                    FrameworkPropertyMetadataOptions.None));

        /// <summary>
        /// Gets or sets the InnerShadowThickness property. This dependency property 
        /// indicates thickness of the inner shadow.
        /// </summary>
        public Thickness InnerShadowThickness
        {
            get { return (Thickness)GetValue(InnerShadowThicknessProperty); }
            set { SetValue(InnerShadowThicknessProperty, value); }
        }
