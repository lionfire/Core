...
namespace System.Windows.Media
{
    ...
    public static class HlsColorExtensions
    {
        ...
        public static HlsColor ToHls(this Color rgbColor)
        {
            // Initialize result
        ...
        public static Color ToRgb(this HlsColor hlsColor)
        {
            // Initialize result
    ...
    public class HlsValueConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            // Return result
            var rgbColorOut = hlsColor.ToRgb();
