#if false // Way too much code duplication, all to get rid of a tiny amount of debug rendering code. Trying without this.
...
public class HeadlessSimulation : IDisposable
{
    ...
    private readonly HeadlessPhysicsProcessor processor;
    ...
    public HeadlessSimulation(HeadlessPhysicsProcessor processor, PhysicsSettings configuration)
    {
    ...
    {
        throw new NotImplementedException(); // Needs port from Stride.Physics
        //if (discreteDynamicsWorld == null) throw new Exception("Cannot perform this action when the physics engine is set to CollisionsOnly");
