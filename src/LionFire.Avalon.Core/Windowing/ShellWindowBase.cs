...
namespace LionFire.Shell
{
    public abstract class ShellWindowBase : Window
    {
        ...
        {
            this.Topmost = WpfLionFireShell.Instance.Topmost;
            this.Activate();
        }
        ...
        {
            WpfLionFireShell.Instance.Topmost ^= true;
        ...
        {
            WpfLionFireShell.Instance.IsDebugWindowVisible ^= true;
        }
        protected void menuButton_Click(object sender, RoutedEventArgs e)
        {
            LionFireShell.Instance.EventAggregator.Publish(Singleton<MToggleAppMenu>.Instance);
        }
        ...
        protected void UpdateTopmost()
        {
            ...
            try
            {
                ...
                if (TopmostEllipse2 != null) TopmostEllipse2.Fill = WpfLionFireShell.Instance.Topmost ? topmostBrush1 : topmostBrush2;
                if (TopmostEllipse1 != null) TopmostEllipse1.Fill = !WpfLionFireShell.Instance.Topmost ? topmostBrush1 : topmostBrush2;
