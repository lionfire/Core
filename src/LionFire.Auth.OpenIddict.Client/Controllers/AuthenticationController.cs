// Based on OpenIddict-Samples: Velousia client (Apache License 2.0)
...
public class AuthenticationController : Controller
{
    ...
    public async Task<ActionResult> LogInCallback()
    {
        ...
        var customRolesType = "roles";

        // Build an identity based on the external claims and that will be used to create the authentication cookie.
        var identity = new ClaimsIdentity(
            authenticationType: "ExternalLogin",
            nameType: ClaimTypes.Name,
            roleType: customRolesType
        ...
        foreach (var claim in result.Principal.GetClaims(customRolesType))
        {
            identity.AddClaim(customRolesType, claim);
        }
