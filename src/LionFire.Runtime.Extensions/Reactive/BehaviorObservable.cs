...
namespace LionFire.Reactive.Subjects
{
    ...
    public sealed class BehaviorObservable<T> : SubjectBase<T>, IDisposable, IBehaviorObservable<T>
    {
        #region Fields
        ...
        public BehaviorObservable(T value)
        {
            _value = value;
        ...
        {
            private readonly BehaviorObservable<T> _subject;
            private IObserver<T> _observer;

            public Subscription(BehaviorObservable<T> subject, IObserver<T> observer)
            {
                _subject = subject;
                _observer = observer;
            }
