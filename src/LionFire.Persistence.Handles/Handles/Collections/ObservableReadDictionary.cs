...
#region Construction
    ...
    public class ObservableReadDictionaryHandle<TReference, THandle, TValue> : ObservableReadDictionary<TReference, THandle, TValue> : IGets<IEnumerable<T>>, IReferenceable<TReference>
