...
//    {
//        //public static H<TValue> ToHandle<TValue>(this string uriString) where TValue : class => DependencyContext.Current.GetService<IReadWriteHandleProvider>().ToHandle<TValue>(new UriStringReference(uriString));
