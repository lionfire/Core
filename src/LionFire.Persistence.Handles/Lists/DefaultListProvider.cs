...
namespace LionFire.Persistence.Persisters
{
    ...
    {
#nullable disable
        public async Task<IEnumerable<IListing<TChildValue>>> List<TChildValue>(IPersister<TReference> persister, IReferenceable<TReference> referencable, ListFilter? filter = null)
           => (await Task.WhenAll(
