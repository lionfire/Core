...
namespace LionFire.Persistence.Persisters
{
         ...
         where TReference : IReference
    {
        ...
        public  Task<IEnumerable<IListing<T>>> List<T>(Type itemType, IPersister<TReference> persister, IReferenceable<TReference> referencable, ListFilter? filter = null)
        {
        ...
        public  Task<IEnumerable<IListing<T>>> List<T>(IPersister<TReference> persister, IReferenceable<TReference> referencable, ListFilter? filter = null)
        {
            // Alternate ideas:
        ...
        //public async Task<IEnumerable<string>> List(IPersister<TReference> persister, IReferenceable<TReference> referencable, ListFilter? filter = null)
    }
}
