...
public class GrainObserverSubscriber<T>(IGrainObservableG<T> observableGrain)
     : IAsyncObserverO<T>
{
    #region Relationship

    public IGrainObservableG<T> ObservableCollection { get; } = observableGrain;

    #endregion

    IAsyncObserverO<T> orleansObjectReference { get; }
