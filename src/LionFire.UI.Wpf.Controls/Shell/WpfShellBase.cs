...
namespace LionFire.Shell
{
    ...
    /// </remarks>
    public abstract class WpfShellBase<TPresenter> : ILionFireShell, INotifyPropertyChanged
        where TPresenter : class, IShellPresenter
    {
        ...
        public WpfShellBase(IServiceProvider serviceProvider, IHostApplicationLifetime hostApplicationLifetime, IOptionsMonitor<StartupInterfaceOptions> interfaceOptionsMonitor, IViewLocator viewLocator, TPresenter shellPresenter, IOptionsMonitor<ShellOptions> shellOptionsMonitor)
        {
            #region Dependencies
