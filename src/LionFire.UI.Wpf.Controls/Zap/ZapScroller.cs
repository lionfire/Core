...
{
    public interface IZapScroller
    {
        event RoutedPropertyChangedEventHandler<int> CurrentItemChanged;
        ItemCollection Items { get; }
        int CurrentItemIndex { get; set; }
    }
    public class ZapScroller : ItemsControl, IZapScroller
    {
        static ZapScroller()
        {
        ...
        public ZapScroller()
        {
            ...
            this.SizeChanged += new SizeChangedEventHandler(ZapScroller_SizeChanged);
        }

        void ZapScroller_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            if(ZapDecorator != null)
            this.ZapDecorator.InvalidateMeasure();
        }

        public ICommand FirstCommand => m_firstCommand;

        public ICommand PreviousCommand => m_previousCommand;

        public ICommand NextCommand => m_nextCommand;
        ...
        public static readonly DependencyProperty OrientationProperty =
            DependencyProperty.Register("Orientation", typeof(Orientation), typeof(ZapScroller),
