...
{
    public class WpfTabs : UIView<WpfTabsView>, ITabs
    {
        public IReadOnlyDictionary<string, IUIKeyed> Children => throw new NotImplementedException();

        public void Add(IUIKeyed node) => throw new NotImplementedException();
    ...
    /// </summary>
    public partial class WpfTabsView : UserControl, /*IControllable, UNUSED*/ INotifyPropertyChanged
#if Windowing
...
#endif
    {
        ...
        public IUIRoot ShellConductor { get; }
        ...
        //#if WPF
        //        IWpfShellContentPresenter MainPresenter => (IWpfShellContentPresenter)ShellConductor.MainPresenter;
        //#else
        ...
        private void InitializeComponent()
        {
            ...
            Noesis.GUI.LoadComponent(this, "TabbedWindowPresenter.xaml");
        }
#endif

        IServiceProvider ServiceProvider; // TEMP - is this still needed?

        public WpfTabsView(IServiceProvider serviceProvider, IUIRoot root, UserLocalSettingsProvider<WindowSettings> windowSettings, string key = null)
        {
        ...
        protected virtual void OnTopmostChanged()
        {
            ...
            {
#if Windowing
                if (MainPresenter is UIWindow wp)
                {
...
#else
            var attr = ti.Content.GetType().GetCustomAttribute<DefaultKeyAttribute>();
#endif
        ...
        public bool ContainsBackground(string tabName) => GetBackgroundTabItem(tabName) != null;
            ...
            ) where T : class
        {
...
#endif
            {
                ...
                if (!this.Contains(tabName))
                {
                    ...
                    // OLD - do the parenting via UIEntities ?
                    //var parented = frameworkElement as IParentable<IOldPresenter>;
                    //if (parented != null)
                    //{
        ...
        public bool HideModalControl(string viewName)
        {
            ...
            var attr = control.GetType().GetCustomAttribute2<DefaultKeyAttribute>();
        ...
        public T ShowBackgroundControl<T>(string tabName = null) where T : class
        {
            ...
            ShowBackgroundTab(tabName);
            //this.BackgroundPresenter.ShowView(tabName);
