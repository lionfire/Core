#if OLD // Old approach.  New way is simpler.
#if NOESIS
using Noesis;
#else
#define Windowing
...
namespace LionFire.Shell
{
    ...
    public class WpfPresenter : PresenterBase, IPresenter, IKeyable, IParented
    {
        ...
        public async Task Show(UIInstantiation instantiation)
        {
        ...
        public Task Show(UIReference context, string viewName = null, UIParameters options = null) => throw new NotImplementedException();
