...
public static class ValidateX
{
    ...
    public static void ValidateOrThrow(this IValidatable obj, object validationKind = null)
    {
        var result = obj.Validate(validationKind);
        if (!result.Valid)
        {
    ...
    /// <summary>
    /// Create a ValidationContext, and run IValidatable.Validate on obj
    /// </summary>
    /// <param name="obj"></param>
    /// <param name="validationKind"></param>
    /// <returns></returns>
    public static ValidationContext Validate(this IValidatable obj, object validationKind = null)
        => ValidateObjectX.Validate(obj, validationKind);
