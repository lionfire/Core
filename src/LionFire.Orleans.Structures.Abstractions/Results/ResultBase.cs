...
[GenerateSerializer]
public  class ResultBase<TErrorNr, TValue> : ResultBase<TErrorNr> where TErrorNr : Enum
{
    [Id(0)] TValue? value;
...
[GenerateSerializer]
public class ResultBase<TErrorNr> where TErrorNr : Enum
{
    public static ResultBase<TErrorNr> Ok { get; } = new();
    ...
    public override string ToString() => IsSuccess ? nameof(ResultBase<TErrorNr>.Ok) : ErrorsText;
