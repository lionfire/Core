...
// REVIEW - consider this instead?  https://github.com/stewienj/SwordfishCollections
...
namespace LionFire.Structures
{
    public class LionFireConcurrentObservableDictionary<TKey, TValue> : ConcurrentDictionary<TKey, TValue>
    {
        ...
        {
            var tryRemove = base.TryRemove(key, out TValue value);
        ...
        {
            return AddPartialObserver(new ActionDictionaryObserver<TKey, TValue>(action), keys);
        }
