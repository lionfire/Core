    ...
    public static class Directories
    {
        ...
        public static string? ProgramData
        {
            get
            {
                if (programData == null)
                {
                    ...
                    programData = SEnvironment.GetEnvironmentVariable("ALLUSERSPROFILE");
        ...
        public static string? RoamingAppData
        {
            get
            {
                if (appData == null)
                {
                    appData = SEnvironment.GetEnvironmentVariable("APPDATA");
        ...
        /// 
        /// Linux:
        /// - consider: $HOME/.config/{AppName}
        /// - consider: $HOME/.cache/{AppName}
        /// </summary>
        public static string? LocalAppData // Rename LocalAppDataDir
        {
            get
            {
                ...
                {
                    localAppData = SEnvironment.GetEnvironmentVariable("LOCALAPPDATA");
