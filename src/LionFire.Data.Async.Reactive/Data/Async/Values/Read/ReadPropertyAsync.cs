...
public class ReadPropertyAsync<TObject, TValue> : AsyncValue<TValue>
{
    ...
    public ReadPropertyAsync(TObject target, AsyncValueOptions? options = null)
    {
        Target = target;
...
public class PropertyAsync_Old<TObject, TValue> : AsyncValue<TValue>
{
    ...
    public PropertyAsync_Old(TObject target, AsyncValueOptions? options = null)
    {
        Target = target;
        Options = options ?? TargetAsync?.Options.PropertyOptions ?? DefaultOptions;
    }
