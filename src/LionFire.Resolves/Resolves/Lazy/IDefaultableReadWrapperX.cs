...
public static class IDefaultableReadWrapperX
{
    ...
    public static ITask<IResolveResult<TValue>> GetValue<TValue>(this IDefaultableReadWrapper<TValue> readWrapper)
    {
        ...
        if (readWrapper is ILazilyResolves<TValue> lr) return lr.TryGetValue(); // UPCAST
    ...
    internal static ITask<IResolveResult<TValue>> DefaultableReadWrapper_GetValue<TValue>(IDefaultableReadWrapper<TValue> readWrapper)
    {
