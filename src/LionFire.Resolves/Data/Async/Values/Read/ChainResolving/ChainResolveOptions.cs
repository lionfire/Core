...
namespace LionFire.Data.Gets.ChainResolving
{
    public class ChainResolveOptions : IParentable<ChainResolveOptions>
    {
        ...
        public static ChainResolveOptions Default = new ChainResolveOptions
        {
            ...
            {
                new ChainResolverWorker(typeof(IGets<object>), o => ((IGets<object>)o).GetIfNeeded()), // Put this first, because it caches results
