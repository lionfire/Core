...
/// </summary>
public static class ChainGetterX
{
    ...
    public static T ResolveTo<T>(this IWrapper<object> hasObject, ChainGetterptions options = null, params object[] parameters)
    {
    ...
    public static ChainGetterptions CurrentOptions => DependencyContext.Current.GetService<IOptionsMonitor<ChainGetterptions>>()?.CurrentValue
            ?? ChainGetterptions.Default;

    public static async Task<ChainGetterResult<T>> ChainResolveAsync<T>(this object obj, ChainGetterptions options = null, params object[] parameters)
    {
        if (options == null) options = CurrentOptions;

        var result = new ChainGetterResult<T>();
        ...
        foreach (var resolver in options.AllResolvers)
        {
            ...
            if (invokeResult is ChainGetterResult<T> crr)
            {
