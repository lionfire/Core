namespace LionFire.Persistence.Handles
{
    public static class PersistenceStateExtensions
    {
        ...
        public static void SetFlag(this ref PersistenceState state, PersistenceState flags, bool isSet = true)
        {
            if (isSet) { state |= state; }
            else { state &= ~flags; }
        }
        public static void UnsetFlag(this ref PersistenceState state, PersistenceState flags) => state.SetFlag(flags, false);
    }
}
