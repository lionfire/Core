...
namespace LionFire.Persistence
{
    ...
    public interface ILazilyRetrievable<out T> : ILazilyRetrievable, IRetrieves<T>
    {
        Task<(bool HasObject, object /* T */ Object)> Get();
    }
    public interface ILazilyRetrievableInvariant<T> : ILazilyRetrievable, IRetrieves<T>
    {
        Task<(bool HasObject, T Object)> Get();
    }

    public interface ILazilyRetrievable : IHasPersistenceState
    {
        /// <summary>
        ...
        /// 
        /// To force a Retrieve, either invoke IRetrieves.Retrieve if supported by this object, or else invoke DiscardObject followed by Get.
        /// </summary>
        /// <seealso cref="Exists"/>
