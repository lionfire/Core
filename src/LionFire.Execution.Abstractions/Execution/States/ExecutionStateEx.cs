...
namespace LionFire.Execution
{
    // FUTURE: State machine with states at nodes and states at edges?
        ...
        // TODO: Replace with the new lighter ExecutionState, and the transitions (which involve transitory states)
    [Flags]
    ...
    {
        ExecutionStateEx ExecutionState { get; }
    }
    public interface IAcceptsExecutionState
    {
        ExecutionStateEx ExecutionState { set; }
    }

    public interface IChangesExecutionState
    {
        IObservable<ExecutionStateEx> ExecutionStates { get; }
    }
