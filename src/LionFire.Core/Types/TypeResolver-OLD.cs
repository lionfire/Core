...
namespace LionFire
{
    ...
    //    public static ITypeNamingContext Default { get => ManualSingleton<ITypeNamingContext>.GuaranteedInstance; set { ManualSingleton<ITypeNamingContext>.Instance = value; } }
