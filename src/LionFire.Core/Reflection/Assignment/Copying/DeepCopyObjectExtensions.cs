...
namespace LionFire.Reflection.Assignment.Copying
{
    /// <summary>
    ...
    {
        public CopyFlags CopyFlags { get { return copyFlags; } }
        private readonly CopyFlags copyFlags;
    ...
    public static class DeepCopyObjectExtensions
    {
        ...
        private static object Clone(this object instance, VisitedGraph visited, CopyFlags copyFlags = CopyFlagsSettings.Default)
        {
            ...
            {
                if (Copyable.AllowFallback)
                {
                    l.Fatal("Error copying " + instance.GetType().Name + ". Falling back to non-copy.");
                    return instance;
                }
                else
                {
        ...
        private static object Clone(this object instance, VisitedGraph visited, object copy, CopyFlags copyFlags = CopyFlagsSettings.Default)
        {
            ...
            while (type != null)
            {
                ...
                if (effectiveFlags.HasFlag(CopyFlags.PublicFields) || effectiveFlags.HasFlag(CopyFlags.NonPublicFields))
                {
                    ...
                    {
                        if (!Copyable.CloneDelegates && typeof(Delegate).IsAssignableFrom(field.FieldType)) continue;
...
, false
                ...
                if (effectiveFlags.HasFlag(CopyFlags.PublicProperties))
                {
                    ...
                    foreach (PropertyInfo property in type.GetProperties(bindingFlags))
                    {
                        ...
                        if (!Copyable.CloneDelegates && typeof(Delegate).IsAssignableFrom(property.PropertyType)) continue;
