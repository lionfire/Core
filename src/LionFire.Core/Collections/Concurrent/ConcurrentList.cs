// Retrieved from http://deanchalk.com/c-fast-parallel-concurrentlistt-implementation/
// on 2014.11.15 
...
{
    public class ConcurrentList<T> : IList, IList<T>
    {
        ...
        public ConcurrentList(IEnumerable<T> items) : this()
        {
            AddRange(items);
        }
