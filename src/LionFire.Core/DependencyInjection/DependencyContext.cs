...
namespace LionFire.DependencyInjection
{
    ...
    public class DependencyContext : IServiceProvider
    {
        ...
        public TInterface GetServiceOrSingleton<TInterface>(IServiceProvider serviceProvider = null, bool createIfMissing = DefaultCreateIfMissing)
            => (TInterface)GetServiceOrSingleton(typeof(TInterface), serviceProvider, createIfMissing);

        public TInterface GetServiceOrSingleton<TInterface, TConcrete>(IServiceProvider serviceProvider = null, bool createIfMissing = DefaultCreateIfMissing)
        ...
        /// </remarks>
        public virtual object GetServiceOrSingleton(Type interfaceType, IServiceProvider serviceProvider = null, bool createIfMissing = true, Type concreteType = null)
        {
