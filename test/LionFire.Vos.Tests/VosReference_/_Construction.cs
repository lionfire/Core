...
namespace VosReference_
{
    public class _Construction
    {
        ...
        public void P_Chunks()
        {
            ...
            var reference1 = new VosReference("testDir", "testSubdir", name);
        ...
        {
            var reference4 = new VosReference("testDir/testSubdir/testfile.subext.txt");
        ...
        {
            var reference3 = new VosReference("/testDir/testSubdir/testfile.subext.txt");
