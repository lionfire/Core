...
public static class VosTestSetup
{
    ...
    public static IServiceCollection AddTestFileMount(this IServiceCollection services, bool autoExtension)
    {
        ...
        services
            .VosMount("/test".ToVobReference(), dir.ToFileReference(), new VobMountOptions()
            {
                ReadPriority = VobMountOptions.DefaultReadPriority,
                WritePriority = VobMountOptions.DefaultWritePriority,
                //Flex = decorators,
            })
