...
namespace RetrieveParticularType
{
    public class RetrieveParticularType_
    {
        [Fact]
        public async void Pass()
        {
            await VosTestHost.Create()
                ...
                .RunAsync(async s =>
                {
                    ...
                    "/test/obj1".ToVobReference();
                    throw new NotImplementedException("assert something");
                });
        }
    }
}
